...
def calculateCostReduced():
    ...
    # Sum all of the salaries found to get total cost reduced    
    # Extract only the Salaries of those found from the two filters 
    # Second filter to find part-time employees # First filter to find employees hired within 1995 to 1999
